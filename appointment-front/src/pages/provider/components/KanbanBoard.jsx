			  ...
			  <StrictModeDroppable droppableId={columnId}>
				{(provided, snapshot) => (
				  <div
					...
					className={`flex-1 min-h-[300px] rounded-lg transition-colors duration-200 ${
					  snapshot.isDraggingOver ? "bg-gray-600/30" : "bg-gray-700/30"
					  ...
					  <Draggable key={String(item.id)} draggableId={String(item.id)} index={index}>
						{(provided, snapshot) => (
						  <div
							...
							className={`relative mb-3 p-4 rounded-lg shadow-lg select-none transition-colors duration-200 ${
