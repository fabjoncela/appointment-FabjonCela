                        ...
                        {appointments.map((appointment) => (
                            <tr key={appointment.id} className="border-b hover:bg-indigo-50">
                                ...
                                <td className="px-6 py-4">
                                    <span
                                        className={`inline-block px-4 py-2 rounded-full text-white ${appointment.status === "request"
                                            ? "bg-yellow-500"
                                ...
                                <td className="px-6 py-4">
                                    <button
                                        ...
                                        className="bg-sky-500 text-white px-4 py-2 rounded-full hover:bg-sky-600 transition"
                                    >
                                        Edit
                                    </button>
                                    <button
